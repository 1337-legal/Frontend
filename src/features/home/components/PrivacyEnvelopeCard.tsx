...
export const PrivacyEnvelopeCard: React.FC = () => (
    <Card className="border-neutral-800 bg-neutral-900/70 backdrop-blur animate-fade-in-up overflow-hidden">
        <CardHeader>
            <CardTitle className="flex items-center gap-2 text-neutral-100"><ShieldCheck className="h-5 w-5 text-orange-400" /> Blindflare Privacy Protocol</CardTitle>
            <CardDescription>Your requests travels opaque.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4 relative">
            ...
            <ul className="space-y-2 text-xs text-neutral-400">
                <li className="flex items-center gap-2"><Spark /> Request body is encrypted before leaving your device.</li>
                <li className="flex items-center gap-2"><Spark /> Edge/CDN providers can't see what your http body contains.</li>
                <li className="flex items-center gap-2"><Spark /> Passwords are never stored, we rely on signature-based auth.</li>
                <li className="flex items-center gap-2"><Spark /> Replies are sealed back the same way.</li>
                <li className="flex items-center gap-2"><Spark /> End-to-end PGP forwarding supported (bring your public key rollout phase or later).</li>
            </ul>
            <div className="mt-4 rounded-md bg-neutral-950/70 p-4 text-[11px] leading-relaxed ring-1 ring-neutral-800">
                ...
                <p className="text-neutral-500">data: 0x8f0c…b7</p>
