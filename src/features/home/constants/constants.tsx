...
export const features: FeatureItem[] = [
    {
        icon: Shield,
        title: 'Strict No KYC',
        desc: 'No government ID, selfies, or personal docs cryptographic trust replaces intrusive verification.',
    },
    {
        icon: Lock,
        title: 'Zero Logs',
        desc: 'No content, request, IP, or session logs retained — nothing to correlate activity.',
    },
    {
        icon: Mail,
        title: 'Humanish Aliases',
        desc: 'Pronounceable semantic triplets—easy to recall, hard to enumerate.',
    },
    {
        icon: Fingerprint,
        title: 'Mnemonic Auth',
        desc: 'Phrase‑based cryptographic derivation; your raw secret never leaves the device.',
    },
    {
        icon: OnionIcon,
        title: 'Tor Friendly',
        desc: 'We are accessible over Tor, allowing you to use our service without revealing your IP address.',
    },
    {
        icon: HatGlasses,
        title: 'Burnable Accounts',
        desc: 'Disappear at any moment. You can burn an alias or your account.',
    },
];
